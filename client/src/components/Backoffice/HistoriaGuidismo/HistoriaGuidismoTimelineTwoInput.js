...
class HistoriaDoGuidismoTimelineTwo extends Component {
  constructor(props) {
    super(props);
    this.state = {
      image: "",
  ...
  componentDidMount = () => {
    ...
    if (getId) {
      axios.get(`/historia-guidismo/timeline-two/${getId}`).then((res) => {
  ...
  postData = () => {
    ...
    if (getId) {
      axios.put(`/historia-guidismo/timeline-two/${getId}`, timeline)
        .then((res) => {
      ...
      axios
        .post("/historia-guidismo/timeline-two", timeline)
        .then((res) => {
          this.setState({ messageStatus: "success" }, () => {
            setTimeout(
              () => history.push({ pathname: "/backoffice/historia-guidismo" }),
  ...
  render() {
    ...
    return (
      <div className="NoticiaInput">
        <div className="NoticiaInput-title">Timeline Olave</div>
...
HistoriaDoGuidismoTimelineTwo.propTypes = {
  match: PropTypes.string.isRequired,
};

export default withRouter(HistoriaDoGuidismoTimelineTwo);
