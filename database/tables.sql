...
CREATE TABLE `news`(
  ...
  `image` TEXT NOT NULL,
  `pt_intro_text` VARCHAR(150) NOT NULL,
  `en_intro_text` VARCHAR(150) NOT NULL,
...
-- DROP TABLE IF EXISTS `journal`;
  ...
  CREATE TABLE `journal` (
    ...
    `pt_title`  VARCHAR(400) NOT NULL,
    `en_title`	VARCHAR(400) NOT NULL,
    `thumbnail`	TEXT NOT NULL,
...
('Livro de Especialidades', 'Badge Book', 'https://drive.google.com/file/d/1x7nByFv5sOGRWCwRB2UzTTE4y3l9TS-o/view?usp=sharing'),
('Cartão de Associada', 'Membership Card', 'https://drive.google.com/file/d/1S5w9UL0mcfvbz64NGykMas-LosrvnMiu/view?usp=sharing');
...
`<p>WAGGGS – World Association of Girl Guides and Girl Scouts – is the largest voluntary Movement dedicated to girls and young women in the world, and AGP is one of its members. It represents 10 million girls and young women from 150 countries, and it's organised in five different Regions: Africa, Arab, Asia Pacific, Western Hemisphere and Europe.</p>`,
...
'Empower girls and young women to promote positive changes in their lives, their communities and countries',
'Ser a voz das raparigas no mundo ',
'Be the voice of girls around the world',
...
'Decisive role in community development:',
...
'<p>WAGGGS five World Centres offer the opportunity of an international adventure. Here, Girl Guides and Girl Scouts can meet, experience a world of different activities and meet Girl Guides and Girl Scouts from other countries, on a self-discovery journey of international scale.</p><ul><li>Sangam, India</li><li>Notre Chalet, Switzerland</li><li>Pax Lodge, United Kingdom</li><li>Nuetra Cabaña, Mexico</li><li>Kusafiri, Africa</li></ul>',
...
'<p>"22 February is a day of celebration, in which we think of other Guide and Scout friends around the world." Baden-Powell</p><p>22 February is a very special day for all Girl Guides and Girl Scouts around the world. It s called "World Thinking Day" and it s when all Girl Guides and Girl Scouts around the world think of each other and celebrate friendship and the ideals of our Movement, as well as celebrate the birthday of Lord Baden-Powell (1857), the founder of the Movement, and Lady Olave Baden-Powell (1889), our World Chief Guide.</p><p>This day has been celebrated since 1926 and it s also a moment to discuss current issues, especially those affecting girls and young women and to raise funds to support WAGGGS action all around the world, in particular for girls empowerment projects.</p><p>It s an opportunity for each Girl Guide to celebrate this day and be one in 10 million, to be inspired by the history and impact of Girl Guiding, to connect with Girl Guides around the world, to develop actions and raise awareness on important issues and to make a difference, raising funds for projects through the World Thinking Day Fund.</p><p>More information about the World Thinking Day here.</p>',
'Tostão Mundial',
...
'</p>"22 February is a day to give and share." Baden-Powell</p><p>In 1932, at the 7th World Conference in Poland, it was suggested that each Girl Guide offered a contribution, besides their thought, to show their friendship and appreciation. The World Thinking Day Fund was created under the motto "A penny for your thoughts", and its goal is to support Girl Guiding and Girl Scouting all around the world.</p><p>During the first few years, the contributions were used in countries that suffered from the consequences of World War II and later to re-establish National Associations in war-torn countries.</p><p>Since then, the World Thinking Day Fund has made the expansion of the Movement possible around the world and has been a way for Girl Guides to help other Girl Guides.</p>'
);
